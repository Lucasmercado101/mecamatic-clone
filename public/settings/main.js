			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('group group-small')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Velocidad minima')
									])),
								A2(
								$elm$html$Html$label,
								_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Coeficiente de errores')
									])),
								A2(
								$elm$html$Html$label,
								_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('group group-small group-radio-only')
							]),
						_List_fromArray(
							[
								A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('form-column last-form')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('group group-large')
							]),
						_List_fromArray(
							[
								A2(
